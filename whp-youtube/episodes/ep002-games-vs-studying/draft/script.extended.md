...
- **Word count (spoken):** ~2,364 after the 2026-08-06 tank-defense addition (≈13–14 minutes spoken) — inside the revised Law 3 ceiling.
...
- **Brace-comment sweep (2026-08-06, first run of the inline review channel):** 15 Martin comments processed, all applied per his merge — the three-accusations rename (folk-belief framing made audible), the attention-market transaction rewrite (seller, buyers, currency assigned before "bid" recurs), the Inzlicht evidence-weight rationale, joke connective repairs (shock-button line; cat-owner topper), the Apexwit credential (PI slot B), the grades-takeaway reframe, hyperfocus name preparation, SP06's explicit two-topic deferral with comments CTA (no-half-wink rule), and the SP07 rule-first compression (deal-over-discipline rule; question-to-imperative pairs; self-grading answer for delayed feedback). Braces stripped; pair, readability, and seam gates re-run. Follow-up (same day): the tank-defense disarm added to SP02 (the viewer's lived evening-depletion evidence answered via the drained-evening gaming clue) and the SP03 model paragraph tightened to make the seller-buyer direction unmistakable (Martin's direction-misread caught in review).
