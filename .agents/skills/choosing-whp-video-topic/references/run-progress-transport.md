...
When a caller's envelope requests `progress_transport: "WHP_PROGRESS/2"`, emit one
...
Version 1 (twelve rows, caller-authored ids) is retired; callers must not emit or
expect it.
